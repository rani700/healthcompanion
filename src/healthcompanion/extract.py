...
_EXTRACTION_PROMPT = (
    ...
    "- For ANY token you cannot read with confidence (name, dose, or word), "
    "transcribe your best reading followed by '[?]'. Never present an uncertain "
    "reading as definite, and never invent text that isn't on the page.\n\n"
